...
replace (
	...
	github.com/daoleno/uniswapv3-sdk v0.4.0 => github.com/KyberNetwork/uniswapv3-sdk v0.4.4
...
require (
	...
	github.com/KyberNetwork/aggregator-encoding v0.1.9
	...
	github.com/KyberNetwork/kyberswap-dex-lib v0.28.7

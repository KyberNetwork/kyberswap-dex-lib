...
require (
	...
	github.com/KyberNetwork/aggregator-encoding v0.49.3
	...
	github.com/KyberNetwork/kyberswap-dex-lib v0.102.8
	github.com/KyberNetwork/kyberswap-dex-lib-private v0.11.1

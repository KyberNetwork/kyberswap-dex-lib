...
func (m *MockIBuildRouteParamsValidator) Validate(arg0 context.Context, arg1 params.BuildRouteParams) error {
	m.ctrl.T.Helper()
...
func (mr *MockIBuildRouteParamsValidatorMockRecorder) Validate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Validate", reflect.TypeOf((*MockIBuildRouteParamsValidator)(nil).Validate), arg0, arg1)
}

...
//
//	mockgen -destination ../../mocks/poolmanager/pool_repository.go -package poolmanager github.com/KyberNetwork/router-service/internal/pkg/usecase/poolmanager IPoolRepository
//

...
func ROneSellQuote(amount *big.Float, state *PoolState) (result *big.Float, err error) {
...
func RAboveSellBase(amount *big.Float, state *PoolState) (result *big.Float, err error) {
	result, err = integrate(state.B0, new(big.Float).Add(state.B, amount), state.B, state.OraclePrice, state.k)
	return
}

func RAboveSellQuote(amount *big.Float, state *PoolState) (result *big.Float, err error) {
	result, err = solveQuadraticFunctionForTrade(
...
func RBelowSellQuote(amount *big.Float, state *PoolState) (result *big.Float, err error) {
...
func RBelowSellBase(amount *big.Float, state *PoolState) (result *big.Float, err error) {
...
func UpdateStateSellBase(amountIn *big.Float, amountOut *big.Float, state *PoolState) {
...
func UpdateStateSellQuote(amountIn *big.Float, amountOut *big.Float, state *PoolState) {

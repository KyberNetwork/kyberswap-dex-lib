...
// not used methods but needed to conform to common interface
func (p *PoolSimulator) GetLpToken() string {
	return ""
}

func (p *PoolSimulator) GetMidPrice(_ string, tokenOut string, _ *big.Int) *big.Int {
	return constant.Zero
}

func (p *PoolSimulator) CalcExactQuote(_ string, tokenOut string, _ *big.Int) *big.Int {
	return constant.Zero
}

...
func (p *Pool) CalcAmountOut(
	...
	result, _, err := p.CalcAmountOutAEVM(params.TokenAmountIn, params.TokenOut, false)
	return result, err
}
...
func (p *Pool) CalcAmountOutAEVM(
	...
	strategy := &aevmcore.AEVMSwapStrategy{
		SwapCalls:       swapCalls,
		AmountOutGetter: aevmcore.AmountOutGetterSwapOutputPackedBytes32,
		AmountOutGetterArgs: aevmcore.AmountOutGetterSwapOutputPackedBytes32Args{

...
//go:generate mockgen -destination ./mock_vault_reader.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IVaultReader
//go:generate mockgen -destination ./mock_vault_price_feed_reader.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IVaultPriceFeedReader
//go:generate mockgen -destination ./mock_fast_price_feed_reader_v1.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IFastPriceFeedV1Reader
//go:generate mockgen -destination ./mock_price_feed_reader.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IPriceFeedReader
//go:generate mockgen -destination ./mock_usdg_reader.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IUSDGReader
//go:generate mockgen -destination ./mock_chainlink_flags_reader.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IChainlinkFlagsReader
//go:generate mockgen -destination ./mock_pancake_pair_reader.go -package gmx dmm-aggregator-backend/internal/pkg/scandex/gmx IPancakePairReader

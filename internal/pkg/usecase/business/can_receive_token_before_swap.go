...
var (
	canReceiveTokenBeforeSwapExchange = map[valueobject.Exchange]bool{
		...
		valueobject.ExchangeArbswapAMM:      true,
		...
		valueobject.ExchangeLiquidusFinance: true,
		valueobject.ExchangeStationDexV2:    true,
		valueobject.ExchangeAbstra:          true,
		...
		valueobject.ExchangeEqual:          true,
		valueobject.ExchangeCleopatra:      true,

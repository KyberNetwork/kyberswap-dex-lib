...
func (d *L2Decoder) decodeSwapData(data []byte, functionSelectorName string, isFirstSwap bool) (interface{}, error) {
	...
	case strings.ToLower(l2executor.FunctionSelectorGmxGlp.RawName):
	...
	case strings.ToLower(l2executor.FunctionSelectorSmardex.RawName):
		return swapdata.UnpackSmardex(data, isFirstSwap)
	default:

...
//go:generate go run go.uber.org/mock/mockgen -destination ../../mocks/poolmanager/pool_factory.go -package poolmanager github.com/KyberNetwork/router-service/internal/pkg/usecase/poolmanager IPoolFactory
...
//go:generate go run go.uber.org/mock/mockgen -destination ../../mocks/poolmanager/pool_rank_repository.go -package poolmanager github.com/KyberNetwork/router-service/internal/pkg/usecase/poolmanager IPoolRankRepository
...
//go:generate go run go.uber.org/mock/mockgen -destination ../../mocks/poolmanager/get_pools_included_base_pools.go -package poolmanager github.com/KyberNetwork/router-service/internal/pkg/usecase/poolmanager IGetPoolsIncludingBasePools

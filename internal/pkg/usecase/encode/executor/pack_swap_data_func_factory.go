...
func init() {
	...
	RegisterPackSwapDataFunc(valueobject.ExchangeRetro, swapdata.PackUniswapV3KSElastic)
	RegisterPackSwapDataFunc(valueobject.ExchangeHorizon, swapdata.PackUniswapV3KSElastic)

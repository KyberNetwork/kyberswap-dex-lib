...
func PackFraxSwap(_ valueobject.ChainID, encodingSwap types.L2EncodingSwap) ([]byte, error) {
...
func UnpackFraxSwap(data []byte, isFirstSwap bool) (Uniswap, error) {
	return UnpackUniswap(data, isFirstSwap)
}

func buildFraxSwap(swap types.L2EncodingSwap) (Uniswap, error) {

...
func init() {
	...
	RegisterFunctionSelector(valueobject.ExchangeZkSwapFinance, FunctionSelectorUniswap)
	...
	RegisterFunctionSelector(valueobject.ExchangeWagmi, FunctionSelectorUniV3KSElastic)
	RegisterFunctionSelector(valueobject.ExchangeMMFV3, FunctionSelectorUniV3KSElastic)
	RegisterFunctionSelector(valueobject.ExchangeMetavaultV3, FunctionSelectorUniV3KSElastic)
	RegisterFunctionSelector(valueobject.ExchangeSolidlyV3, FunctionSelectorUniV3KSElastic)
	RegisterFunctionSelector(valueobject.ExchangeZero, FunctionSelectorUniV3KSElastic)
	RegisterFunctionSelector(valueobject.ExchangeZebraV2, FunctionSelectorUniV3KSElastic)
	...
	RegisterFunctionSelector(valueobject.ExchangeSkydrome, FunctionSelectorVelodrome)
	...
	// executeVelocoreV2
	RegisterFunctionSelector(valueobject.ExchangeVelocoreV2CPMM, FunctionSelectorVelocoreV2)
	RegisterFunctionSelector(valueobject.ExchangeVelocoreV2WombatStable, FunctionSelectorVelocoreV2)
}

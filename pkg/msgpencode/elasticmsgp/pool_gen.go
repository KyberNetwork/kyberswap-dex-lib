...
// DecodeMsg implements msgp.Decodable
func (z *LinkedListData) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0001 uint32
	zb0001, err = dc.ReadArrayHeader()
	if err != nil {
		err = msgp.WrapError(err)
...
// EncodeMsg implements msgp.Encodable
func (z LinkedListData) EncodeMsg(en *msgp.Writer) (err error) {
	// array header, size 2
	err = en.Append(0x92)
	if err != nil {
		return
	}
	err = en.WriteInt(z.Previous)
	if err != nil {
		err = msgp.WrapError(err, "Previous")
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z LinkedListData) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// array header, size 2
	o = append(o, 0x92)
	o = msgp.AppendInt(o, z.Previous)
	o = msgp.AppendInt(o, z.Next)
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *LinkedListData) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadArrayHeaderBytes(bts)
	if err != nil {
		err = msgp.WrapError(err)
	...
	z.Previous, bts, err = msgp.ReadIntBytes(bts)
	if err != nil {
		err = msgp.WrapError(err, "Previous")
		return
	}
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z LinkedListData) Msgsize() (s int) {
...
func (z *Pool) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0007 []byte
			zb0007, err = dc.ReadBytes(msgpencode.EncodeInt(z.SqrtP))
			if err != nil {
				err = msgp.WrapError(err, "SqrtP")
				return
			}
			z.SqrtP = msgpencode.DecodeInt(zb0007)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "BaseL")
			return
		}
		z.BaseL = nil
	} else {
		{
			var zb0008 []byte
			zb0008, err = dc.ReadBytes(msgpencode.EncodeInt(z.BaseL))
			if err != nil {
				err = msgp.WrapError(err, "BaseL")
				return
			}
			z.BaseL = msgpencode.DecodeInt(zb0008)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "ReinvestL")
			return
		}
		z.ReinvestL = nil
	} else {
		{
			var zb0009 []byte
			zb0009, err = dc.ReadBytes(msgpencode.EncodeInt(z.ReinvestL))
			if err != nil {
				err = msgp.WrapError(err, "ReinvestL")
				return
			}
			z.ReinvestL = msgpencode.DecodeInt(zb0009)
		}
	}
	z.CurrentTick, err = dc.ReadInt()
	if err != nil {
		err = msgp.WrapError(err, "CurrentTick")
		return
	}
	z.NearestCurrentTick, err = dc.ReadInt()
	if err != nil {
		err = msgp.WrapError(err, "NearestCurrentTick")
		return
	}
	var zb0011 string
	var zb0010 uint32
	...
	if z.Ticks == nil {
		z.Ticks = make(map[intAsStr]TickData, zb0010)
	} else if len(z.Ticks) > 0 {
		for key := range z.Ticks {
			delete(z.Ticks, key)
		}
	}
	var field []byte
	...
	for zb0010 > 0 {
		...
		za0001 = stringToInt(zb0011)
		err = za0002.DecodeMsg(dc)
		if err != nil {
			err = msgp.WrapError(err, "Ticks", za0001)
			return
		}
		z.Ticks[za0001] = za0002
	}
	var zb0013 string
	var zb0012 uint32
	zb0012, err = dc.ReadMapHeader()
	if err != nil {
		err = msgp.WrapError(err, "InitializedTicks")
		return
	}
	if z.InitializedTicks == nil {
		z.InitializedTicks = make(map[intAsStr]LinkedListData, zb0012)
	} else if len(z.InitializedTicks) > 0 {
		for key := range z.InitializedTicks {
			delete(z.InitializedTicks, key)
		}
	}
	for zb0012 > 0 {
		zb0012--
		var za0003 intAsStr
		var za0004 LinkedListData
		zb0013, err = dc.ReadString()
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks")
			return
		}
		za0003 = stringToInt(zb0013)
		var zb0014 uint32
		zb0014, err = dc.ReadArrayHeader()
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003)
			return
		}
		if zb0014 != 2 {
		...
		za0004.Previous, err = dc.ReadInt()
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003, "Previous")
			return
		}
		za0004.Next, err = dc.ReadInt()
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003, "Next")
			return
		}
		z.InitializedTicks[za0003] = za0004
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
...
func (z *Pool) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.SqrtP == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeInt(z.SqrtP))
		if err != nil {
			err = msgp.WrapError(err, "SqrtP")
			return
		}
	...
	if z.BaseL == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeInt(z.BaseL))
		if err != nil {
			err = msgp.WrapError(err, "BaseL")
			return
		}
	...
	if z.ReinvestL == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeInt(z.ReinvestL))
		if err != nil {
			err = msgp.WrapError(err, "ReinvestL")
			return
		}
	}
	err = en.WriteInt(z.CurrentTick)
	if err != nil {
		err = msgp.WrapError(err, "CurrentTick")
		return
	}
	err = en.WriteInt(z.NearestCurrentTick)
	if err != nil {
		err = msgp.WrapError(err, "NearestCurrentTick")
		return
	}
	err = en.WriteMapHeader(uint32(len(z.Ticks)))
	if err != nil {
		err = msgp.WrapError(err, "Ticks")
		return
	}
	for za0001, za0002 := range z.Ticks {
		err = en.WriteString(intToString(za0001))
		if err != nil {
			err = msgp.WrapError(err, "Ticks")
			return
		}
	...
	err = en.WriteMapHeader(uint32(len(z.InitializedTicks)))
	if err != nil {
		err = msgp.WrapError(err, "InitializedTicks")
		return
	}
	for za0003, za0004 := range z.InitializedTicks {
		err = en.WriteString(intToString(za0003))
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks")
			return
		}
		...
		err = en.WriteInt(za0004.Previous)
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003, "Previous")
			return
		}
		err = en.WriteInt(za0004.Next)
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003, "Next")
			return
		}
...
func (z *Pool) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.SqrtP == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.SqrtP))
	}
	if z.BaseL == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.BaseL))
	}
	if z.ReinvestL == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.ReinvestL))
	}
	o = msgp.AppendInt(o, z.CurrentTick)
	o = msgp.AppendInt(o, z.NearestCurrentTick)
	o = msgp.AppendMapHeader(o, uint32(len(z.Ticks)))
	for za0001, za0002 := range z.Ticks {
		o = msgp.AppendString(o, intToString(za0001))
	...
	o = msgp.AppendMapHeader(o, uint32(len(z.InitializedTicks)))
	for za0003, za0004 := range z.InitializedTicks {
		o = msgp.AppendString(o, intToString(za0003))
		// array header, size 2
		o = append(o, 0x92)
		o = msgp.AppendInt(o, za0004.Previous)
		o = msgp.AppendInt(o, za0004.Next)
	}
	if z.token0Price == nil {
		o = msgp.AppendNil(o)
	} else {
...
func (z *Pool) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0007 []byte
			zb0007, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.SqrtP))
			if err != nil {
				err = msgp.WrapError(err, "SqrtP")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0008 []byte
			zb0008, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.BaseL))
			if err != nil {
				err = msgp.WrapError(err, "BaseL")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0009 []byte
			zb0009, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.ReinvestL))
			if err != nil {
				err = msgp.WrapError(err, "ReinvestL")
				return
			}
	...
	z.CurrentTick, bts, err = msgp.ReadIntBytes(bts)
	if err != nil {
		err = msgp.WrapError(err, "CurrentTick")
		return
	}
	z.NearestCurrentTick, bts, err = msgp.ReadIntBytes(bts)
	if err != nil {
		err = msgp.WrapError(err, "NearestCurrentTick")
		return
	}
	...
	for zb0012 > 0 {
		...
		za0004.Previous, bts, err = msgp.ReadIntBytes(bts)
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003, "Previous")
			return
		}
		za0004.Next, bts, err = msgp.ReadIntBytes(bts)
		if err != nil {
			err = msgp.WrapError(err, "InitializedTicks", za0003, "Next")
			return
		}
...
func (z *Pool) Msgsize() (s int) {
	...
	if z.SqrtP == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.SqrtP))
	}
	if z.BaseL == nil {
		s += msgp.NilSize
	} else {
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.BaseL))
	}
	if z.ReinvestL == nil {
		s += msgp.NilSize
	} else {
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.ReinvestL))
	}
	s += msgp.IntSize + msgp.IntSize + msgp.MapHeaderSize
	if z.Ticks != nil {
		for za0001, za0002 := range z.Ticks {
			_ = za0002
			s += msgp.StringPrefixSize + len(intToString(za0001)) + za0002.Msgsize()
		}
	}
	...
	if z.InitializedTicks != nil {
		for za0003, za0004 := range z.InitializedTicks {
			_ = za0004
			s += msgp.StringPrefixSize + len(intToString(za0003)) + 1 + msgp.IntSize + msgp.IntSize
		}
	}
	if z.token0Price == nil {
		s += msgp.NilSize
...
// DecodeMsg implements msgp.Decodable
func (z *TickData) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0001 uint32
	zb0001, err = dc.ReadArrayHeader()
	if err != nil {
		err = msgp.WrapError(err)
...
// EncodeMsg implements msgp.Encodable
func (z *TickData) EncodeMsg(en *msgp.Writer) (err error) {
	// array header, size 2
	err = en.Append(0x92)
	if err != nil {
		return
...
// MarshalMsg implements msgp.Marshaler
func (z *TickData) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// array header, size 2
	o = append(o, 0x92)
	if z.LiquidityGross == nil {
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *TickData) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadArrayHeaderBytes(bts)
	if err != nil {
		err = msgp.WrapError(err)
...
// DecodeMsg implements msgp.Decodable
func (z *intAsStr) DecodeMsg(dc *msgp.Reader) (err error) {
	{
		var zb0001 string
		...
		(*z) = stringToInt(zb0001)
	}
	return
}

// EncodeMsg implements msgp.Encodable
func (z intAsStr) EncodeMsg(en *msgp.Writer) (err error) {
	err = en.WriteString(intToString(z))
	if err != nil {
		err = msgp.WrapError(err)
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z intAsStr) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	o = msgp.AppendString(o, intToString(z))
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *intAsStr) UnmarshalMsg(bts []byte) (o []byte, err error) {
	{
		var zb0001 string
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z intAsStr) Msgsize() (s int) {
	s = msgp.StringPrefixSize + len(intToString(z))
	return
}

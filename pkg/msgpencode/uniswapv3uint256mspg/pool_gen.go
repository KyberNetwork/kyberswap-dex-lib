...
func (z *Pool) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0007 []byte
			zb0007, err = dc.ReadBytes(msgpencode.EncodeUint256(z.SqrtRatioX96))
			if err != nil {
				err = msgp.WrapError(err, "SqrtRatioX96")
				return
			}
			z.SqrtRatioX96 = msgpencode.DecodeUint256(zb0007)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		...
		{
			var zb0008 []byte
			zb0008, err = dc.ReadBytes(msgpencode.EncodeUint256(z.Liquidity))
			if err != nil {
				err = msgp.WrapError(err, "Liquidity")
				return
			}
			z.Liquidity = msgpencode.DecodeUint256(zb0008)
		}
	}
...
func (z *Pool) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.SqrtRatioX96 == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeUint256(z.SqrtRatioX96))
		if err != nil {
			err = msgp.WrapError(err, "SqrtRatioX96")
			return
		}
	...
	if z.Liquidity == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeUint256(z.Liquidity))
		if err != nil {
			err = msgp.WrapError(err, "Liquidity")
			return
		}
...
func (z *Pool) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.SqrtRatioX96 == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeUint256(z.SqrtRatioX96))
	}
	if z.Liquidity == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendBytes(o, msgpencode.EncodeUint256(z.Liquidity))
	}
...
func (z *Pool) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0007 []byte
			zb0007, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.SqrtRatioX96))
			if err != nil {
				err = msgp.WrapError(err, "SqrtRatioX96")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0008 []byte
			zb0008, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.Liquidity))
			if err != nil {
				err = msgp.WrapError(err, "Liquidity")
				return
			}
...
func (z *Pool) Msgsize() (s int) {
	...
	if z.SqrtRatioX96 == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeUint256(z.SqrtRatioX96))
	}
	if z.Liquidity == nil {
		s += msgp.NilSize
	} else {
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeUint256(z.Liquidity))
	}
...
func (z *Tick) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0002 []byte
			zb0002, err = dc.ReadBytes(msgpencode.EncodeUint256(z.LiquidityGross))
			if err != nil {
				err = msgp.WrapError(err, "LiquidityGross")
				return
			}
			z.LiquidityGross = msgpencode.DecodeUint256(zb0002)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		...
		{
			var zb0003 []byte
			zb0003, err = dc.ReadBytes(msgpencode.EncodeInt256(z.LiquidityNet))
			if err != nil {
				err = msgp.WrapError(err, "LiquidityNet")
				return
			}
			z.LiquidityNet = msgpencode.DecodeInt256(zb0003)
		}
	}
	return
}
...
func (z *Tick) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.LiquidityGross == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeUint256(z.LiquidityGross))
		if err != nil {
			err = msgp.WrapError(err, "LiquidityGross")
			return
		}
	...
	if z.LiquidityNet == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeInt256(z.LiquidityNet))
		if err != nil {
			err = msgp.WrapError(err, "LiquidityNet")
			return
		}
...
func (z *Tick) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.LiquidityGross == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeUint256(z.LiquidityGross))
	}
	if z.LiquidityNet == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendBytes(o, msgpencode.EncodeInt256(z.LiquidityNet))
	}
	return
}
...
func (z *Tick) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0002 []byte
			zb0002, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.LiquidityGross))
			if err != nil {
				err = msgp.WrapError(err, "LiquidityGross")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0003 []byte
			zb0003, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt256(z.LiquidityNet))
			if err != nil {
				err = msgp.WrapError(err, "LiquidityNet")
				return
			}
...
func (z *Tick) Msgsize() (s int) {
	...
	if z.LiquidityGross == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeUint256(z.LiquidityGross))
	}
	if z.LiquidityNet == nil {
		s += msgp.NilSize
	} else {
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt256(z.LiquidityNet))
	}
	return
}

...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "DefaultWithdrawFee")
			return
		}
		z.DefaultWithdrawFee = nil
	} else {
		{
			var zb0007 []byte
			zb0007, err = dc.ReadBytes(msgpencode.EncodeInt(z.DefaultWithdrawFee))
			if err != nil {
				err = msgp.WrapError(err, "DefaultWithdrawFee")
				return
			}
			z.DefaultWithdrawFee = msgpencode.DecodeInt(zb0007)
		}
	}
	...
	if dc.IsNil() {
		...
		{
			var zb0008 []byte
			zb0008, err = dc.ReadBytes(msgpencode.EncodeInt(z.LpSupply))
			if err != nil {
				err = msgp.WrapError(err, "LpSupply")
				return
			}
			z.LpSupply = msgpencode.DecodeInt(zb0008)
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.DefaultWithdrawFee == nil {
		err = en.WriteNil()
		if err != nil {
			return
		}
	} else {
		err = en.WriteBytes(msgpencode.EncodeInt(z.DefaultWithdrawFee))
		if err != nil {
			err = msgp.WrapError(err, "DefaultWithdrawFee")
			return
		}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.DefaultWithdrawFee == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.DefaultWithdrawFee))
	}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0007 []byte
			zb0007, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.DefaultWithdrawFee))
			if err != nil {
				err = msgp.WrapError(err, "DefaultWithdrawFee")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0008 []byte
			zb0008, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.LpSupply))
			if err != nil {
				err = msgp.WrapError(err, "LpSupply")
				return
			}
...
func (z *PoolSimulator) Msgsize() (s int) {
	...
	if z.DefaultWithdrawFee == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.DefaultWithdrawFee))
	}

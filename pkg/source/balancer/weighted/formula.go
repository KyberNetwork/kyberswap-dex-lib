...
var ONE_18 = bignumber.TenPowInt(18)
var ONE_20 = bignumber.TenPowInt(20)
var ONE_36 = bignumber.TenPowInt(36)
...
var LN_36_LOWER_BOUND = new(big.Int).Sub(ONE_18, bignumber.TenPowInt(17))
var LN_36_UPPER_BOUND = new(big.Int).Add(ONE_18, bignumber.TenPowInt(17))
var MILD_EXPONENT_BOUND = new(big.Int).Div(new(big.Int).Exp(bignumber.Two, big.NewInt(254), nil), ONE_20)
var x0 = bignumber.NewBig10("128000000000000000000")
var a0 = bignumber.NewBig10("38877084059945950922200000000000000000000000000000000000")
var x1 = bignumber.NewBig10("64000000000000000000")
var a1 = bignumber.NewBig10("6235149080811616882910000000")

var x2 = bignumber.NewBig10("3200000000000000000000")
var a2 = bignumber.NewBig10("7896296018268069516100000000000000")
var x3 = bignumber.NewBig10("1600000000000000000000")
var a3 = bignumber.NewBig10("888611052050787263676000000")
var x4 = bignumber.NewBig10("800000000000000000000")
var a4 = bignumber.NewBig10("298095798704172827474000")
var x5 = bignumber.NewBig10("400000000000000000000")
var a5 = bignumber.NewBig10("5459815003314423907810")
var x6 = bignumber.NewBig10("200000000000000000000")
var a6 = bignumber.NewBig10("738905609893065022723")
var x7 = bignumber.NewBig10("100000000000000000000")
var a7 = bignumber.NewBig10("271828182845904523536")
var x8 = bignumber.NewBig10("50000000000000000000")
var a8 = bignumber.NewBig10("164872127070012814685")
var x9 = bignumber.NewBig10("25000000000000000000")
var a9 = bignumber.NewBig10("128402541668774148407")
var x10 = bignumber.NewBig10("12500000000000000000")
var a10 = bignumber.NewBig10("113314845306682631683")
var x11 = bignumber.NewBig10("6250000000000000000")
var a11 = bignumber.NewBig10("106449445891785942956")
...
func exp(x *big.Int) *big.Int {
	...
	if x.Cmp(x0) >= 0 {
		...
		firstAN = bignumber.One
	}
	x = new(big.Int).Mul(x, bignumber.TenPowInt(2))
	var product = ONE_20
	if x.Cmp(x2) >= 0 {
	...
	term = new(big.Int).Div(new(big.Int).Div(new(big.Int).Mul(term, x), ONE_20), bignumber.Two)
	seriesSum = new(big.Int).Add(seriesSum, term)
	...
	seriesSum = new(big.Int).Add(seriesSum, term)
	return new(big.Int).Div(new(big.Int).Mul(new(big.Int).Div(new(big.Int).Mul(product, seriesSum), ONE_20), firstAN), bignumber.TenPowInt(2))
}
...
func _ln(a *big.Int) *big.Int {
	...
	sum = new(big.Int).Mul(sum, bignumber.TenPowInt(2))
	a = new(big.Int).Mul(a, bignumber.TenPowInt(2))
	...
	seriesSum = new(big.Int).Mul(seriesSum, bignumber.Two)
	return new(big.Int).Div(new(big.Int).Add(sum, seriesSum), bignumber.TenPowInt(2))
}
...
func _ln_36(x *big.Int) *big.Int {
	...
	return new(big.Int).Mul(seriesSum, bignumber.Two)
}

...
var _ = poollist.RegisterFactoryCE(DexTypeMuteSwitch, NewPoolListUpdater)
...
func (d *PoolListUpdater) processBatch(ctx context.Context, poolAddresses []common.Address) ([]entity.Pool, error) {
	var (
		...
		poolMetadata = make([]MuteSwitchMetadata, limit)

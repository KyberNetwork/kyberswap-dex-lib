...
import (
	"github.com/KyberNetwork/kyberswap-dex-lib/pkg/msgpencode/elasticmsgp"
...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "elasticPool")
			return
		}
		z.elasticPool = nil
	} else {
		{
			var zb0002 []byte
			zb0002, err = dc.ReadBytes(elasticmsgp.EncodePool(z.elasticPool))
			if err != nil {
				err = msgp.WrapError(err, "elasticPool")
				return
			}
			z.elasticPool = elasticmsgp.DecodePool(zb0002)
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.elasticPool == nil {
		err = en.WriteNil()
		if err != nil {
			return
		}
	} else {
		err = en.WriteBytes(elasticmsgp.EncodePool(z.elasticPool))
		if err != nil {
			err = msgp.WrapError(err, "elasticPool")
			return
		}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.elasticPool == nil {
		...
		o = msgp.AppendBytes(o, elasticmsgp.EncodePool(z.elasticPool))
	}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0002 []byte
			zb0002, bts, err = msgp.ReadBytesBytes(bts, elasticmsgp.EncodePool(z.elasticPool))
			if err != nil {
				err = msgp.WrapError(err, "elasticPool")
				return
			}
...
func (z *PoolSimulator) Msgsize() (s int) {
	...
	if z.elasticPool == nil {
		...
		s += msgp.BytesPrefixSize + len(elasticmsgp.EncodePool(z.elasticPool))
	}
	s += z.gas.Msgsize() + msgp.IntSize + msgp.IntSize
	return
}

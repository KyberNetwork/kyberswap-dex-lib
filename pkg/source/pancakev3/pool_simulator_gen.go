...
import (
	"github.com/KyberNetwork/kyberswap-dex-lib/pkg/msgpencode/pancakev3msgp"
...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0002 []byte
			zb0002, err = dc.ReadBytes(pancakev3msgp.EncodePool(z.V3Pool))
			if err != nil {
				err = msgp.WrapError(err, "V3Pool")
				return
			}
			z.V3Pool = pancakev3msgp.DecodePool(zb0002)
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.V3Pool == nil {
		...
		err = en.WriteBytes(pancakev3msgp.EncodePool(z.V3Pool))
		if err != nil {
			err = msgp.WrapError(err, "V3Pool")
			return
		}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.V3Pool == nil {
		...
		o = msgp.AppendBytes(o, pancakev3msgp.EncodePool(z.V3Pool))
	}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0002 []byte
			zb0002, bts, err = msgp.ReadBytesBytes(bts, pancakev3msgp.EncodePool(z.V3Pool))
			if err != nil {
				err = msgp.WrapError(err, "V3Pool")
				return
			}
...
func (z *PoolSimulator) Msgsize() (s int) {
	...
	if z.V3Pool == nil {
		...
		s += msgp.BytesPrefixSize + len(pancakev3msgp.EncodePool(z.V3Pool))
	}

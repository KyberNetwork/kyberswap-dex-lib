...
const (
	DexTypeLiquidityBookV22 = "liquiditybook-v22"
)
...
const (
	...
	// https://github.com/traderjoe-xyz/joe-v2/blob/v2.2.0/src/libraries/Constants.sol#L20
	basisPointMax = 10000

	// https://github.com/traderjoe-xyz/joe-v2/blob/v2.2.0/src/libraries/Constants.sol#L11
	scaleOffset = 128

	// https://github.com/traderjoe-xyz/joe-v2/blob/v2.2.0/src/libraries/PriceHelper.sol#L20
	realIDShift = 1 << 23

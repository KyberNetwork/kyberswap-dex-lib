...
func (z *FastPriceFeed) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0001 uint32
...
func (z *FastPriceFeed) EncodeMsg(en *msgp.Writer) (err error) {
...
func (z *FastPriceFeed) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *FastPriceFeed) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0001 uint32
...
func (z *FastPriceFeed) Msgsize() (s int) {
	s = 1
	if z.DisableFastPriceVoteCount == nil {
		s += msgp.NilSize
	} else {
...
func (z *PriceDataItem) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0003 []byte
			zb0003, err = dc.ReadBytes(msgpencode.EncodeInt(z.RefTime))
			if err != nil {
				err = msgp.WrapError(err, "RefTime")
				return
			}
			z.RefTime = msgpencode.DecodeInt(zb0003)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		...
		z.CumulativeRefDelta = nil
	} else {
		{
			var zb0004 []byte
			zb0004, err = dc.ReadBytes(msgpencode.EncodeInt(z.CumulativeRefDelta))
			if err != nil {
				err = msgp.WrapError(err, "CumulativeRefDelta")
				return
			}
			z.CumulativeRefDelta = msgpencode.DecodeInt(zb0004)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		...
		z.CumulativeFastDelta = nil
	} else {
		{
			var zb0005 []byte
			zb0005, err = dc.ReadBytes(msgpencode.EncodeInt(z.CumulativeFastDelta))
			if err != nil {
				err = msgp.WrapError(err, "CumulativeFastDelta")
				return
			}
			z.CumulativeFastDelta = msgpencode.DecodeInt(zb0005)
		}
	}
	return
}
...
func (z *PriceDataItem) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.RefTime == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeInt(z.RefTime))
		if err != nil {
			err = msgp.WrapError(err, "RefTime")
			return
		}
	}
	if z.CumulativeRefDelta == nil {
		err = en.WriteNil()
		if err != nil {
			return
		}
	} else {
		err = en.WriteBytes(msgpencode.EncodeInt(z.CumulativeRefDelta))
		if err != nil {
			err = msgp.WrapError(err, "CumulativeRefDelta")
			return
		}
	}
	if z.CumulativeFastDelta == nil {
		err = en.WriteNil()
		if err != nil {
			return
		}
	} else {
		err = en.WriteBytes(msgpencode.EncodeInt(z.CumulativeFastDelta))
		if err != nil {
			err = msgp.WrapError(err, "CumulativeFastDelta")
			return
		}
...
func (z *PriceDataItem) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.RefTime == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.RefTime))
	}
	if z.CumulativeRefDelta == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.CumulativeRefDelta))
	}
	if z.CumulativeFastDelta == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.CumulativeFastDelta))
	}
	return
}
...
func (z *PriceDataItem) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0003 []byte
			zb0003, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.RefTime))
			if err != nil {
				err = msgp.WrapError(err, "RefTime")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0004 []byte
			zb0004, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.CumulativeRefDelta))
			if err != nil {
				err = msgp.WrapError(err, "CumulativeRefDelta")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0005 []byte
			zb0005, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.CumulativeFastDelta))
			if err != nil {
				err = msgp.WrapError(err, "CumulativeFastDelta")
				return
			}
...
func (z *PriceDataItem) Msgsize() (s int) {
	...
	if z.RefTime == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.RefTime))
	}
	if z.CumulativeRefDelta == nil {
		s += msgp.NilSize
	} else {
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.CumulativeRefDelta))
	}
	if z.CumulativeFastDelta == nil {
		s += msgp.NilSize
	} else {
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.CumulativeFastDelta))
	}
	return
}

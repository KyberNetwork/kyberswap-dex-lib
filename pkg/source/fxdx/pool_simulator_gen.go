...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		if z.feeUtils == nil {
			z.feeUtils = new(FeeUtilsV2)
		}
		err = z.feeUtils.DecodeMsg(dc)
		if err != nil {
			err = msgp.WrapError(err, "feeUtils")
			return
		}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		bts, err = z.feeUtils.UnmarshalMsg(bts)
		if err != nil {
			err = msgp.WrapError(err, "feeUtils")
			return
		}

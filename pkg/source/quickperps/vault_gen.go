...
func (z *Vault) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if err != nil {
		err = msgp.WrapError(err, "USDQAmounts")
		return
	}
	if z.USDQAmounts == nil {
		z.USDQAmounts = make(map[string]*big.Int, zb0017)
	} else if len(z.USDQAmounts) > 0 {
		for key := range z.USDQAmounts {
			delete(z.USDQAmounts, key)
		}
	}
	for zb0017 > 0 {
		zb0017--
		...
		if dc.IsNil() {
			err = dc.ReadNil()
			if err != nil {
				err = msgp.WrapError(err, "USDQAmounts", za0012)
				return
			}
			za0013 = nil
		} else {
		...
		z.USDQAmounts[za0012] = za0013
	}
	var zb0019 uint32
	zb0019, err = dc.ReadMapHeader()
	if err != nil {
		err = msgp.WrapError(err, "MaxUSDQAmounts")
		return
	}
	if z.MaxUSDQAmounts == nil {
		z.MaxUSDQAmounts = make(map[string]*big.Int, zb0019)
	} else if len(z.MaxUSDQAmounts) > 0 {
		for key := range z.MaxUSDQAmounts {
			delete(z.MaxUSDQAmounts, key)
		}
	}
	for zb0019 > 0 {
		zb0019--
		...
		if dc.IsNil() {
			err = dc.ReadNil()
			if err != nil {
				err = msgp.WrapError(err, "MaxUSDQAmounts", za0014)
				return
			}
			za0015 = nil
		} else {
		...
		z.MaxUSDQAmounts[za0014] = za0015
	}
	var zb0021 uint32
	...
	{
		var zb0024 []byte
		zb0024, err = dc.ReadBytes((common.Address).Bytes(z.USDQAddress))
		if err != nil {
			err = msgp.WrapError(err, "USDQAddress")
			return
		}
		z.USDQAddress = common.BytesToAddress(zb0024)
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "USDQ")
			return
		}
		z.USDQ = nil
	} else {
...
func (z *Vault) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.WriteMapHeader(uint32(len(z.USDQAmounts)))
	if err != nil {
		err = msgp.WrapError(err, "USDQAmounts")
		return
	}
	for za0012, za0013 := range z.USDQAmounts {
	...
	err = en.WriteMapHeader(uint32(len(z.MaxUSDQAmounts)))
	if err != nil {
		err = msgp.WrapError(err, "MaxUSDQAmounts")
		return
	}
	for za0014, za0015 := range z.MaxUSDQAmounts {
	...
	err = en.WriteBytes((common.Address).Bytes(z.USDQAddress))
	if err != nil {
		err = msgp.WrapError(err, "USDQAddress")
		return
	}
...
func (z *Vault) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendMapHeader(o, uint32(len(z.USDQAmounts)))
	for za0012, za0013 := range z.USDQAmounts {
	...
	o = msgp.AppendMapHeader(o, uint32(len(z.MaxUSDQAmounts)))
	for za0014, za0015 := range z.MaxUSDQAmounts {
	...
	o = msgp.AppendBytes(o, (common.Address).Bytes(z.USDQAddress))
	if z.USDQ == nil {
		o = msgp.AppendNil(o)
	} else {
		o, err = z.USDQ.MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "USDQ")
			return
		}
...
func (z *Vault) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	{
		var zb0024 []byte
		zb0024, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.USDQAddress))
		if err != nil {
			err = msgp.WrapError(err, "USDQAddress")
			return
		}
	...
	if msgp.IsNil(bts) {
		...
		bts, err = z.USDQ.UnmarshalMsg(bts)
		if err != nil {
			err = msgp.WrapError(err, "USDQ")
			return
		}
...
func (z *Vault) Msgsize() (s int) {
	...
	s += msgp.BytesPrefixSize + len((common.Address).Bytes(z.USDQAddress))
	if z.USDQ == nil {
		s += msgp.NilSize
	} else {
		s += z.USDQ.Msgsize()

...
func (z *USDQ) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0001 uint32
...
func (z *USDQ) EncodeMsg(en *msgp.Writer) (err error) {
	// array header, size 2
	err = en.Append(0x92)
	if err != nil {
		return
...
func (z *USDQ) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *USDQ) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0001 uint32

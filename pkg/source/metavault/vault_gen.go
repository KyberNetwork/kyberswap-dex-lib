...
func (z *Vault) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if err != nil {
		err = msgp.WrapError(err, "USDMAmounts")
		return
	}
	if z.USDMAmounts == nil {
		z.USDMAmounts = make(map[string]*big.Int, zb0017)
	} else if len(z.USDMAmounts) > 0 {
		for key := range z.USDMAmounts {
			delete(z.USDMAmounts, key)
		}
	}
	for zb0017 > 0 {
		zb0017--
		...
		if dc.IsNil() {
			err = dc.ReadNil()
			if err != nil {
				err = msgp.WrapError(err, "USDMAmounts", za0012)
				return
			}
			za0013 = nil
		} else {
		...
		z.USDMAmounts[za0012] = za0013
	}
	var zb0019 uint32
	zb0019, err = dc.ReadMapHeader()
	if err != nil {
		err = msgp.WrapError(err, "MaxUSDMAmounts")
		return
	}
	if z.MaxUSDMAmounts == nil {
		z.MaxUSDMAmounts = make(map[string]*big.Int, zb0019)
	} else if len(z.MaxUSDMAmounts) > 0 {
		for key := range z.MaxUSDMAmounts {
			delete(z.MaxUSDMAmounts, key)
		}
	}
	for zb0019 > 0 {
		zb0019--
		...
		if dc.IsNil() {
			err = dc.ReadNil()
			if err != nil {
				err = msgp.WrapError(err, "MaxUSDMAmounts", za0014)
				return
			}
			za0015 = nil
		} else {
		...
		z.MaxUSDMAmounts[za0014] = za0015
	}
	var zb0021 uint32
	...
	{
		var zb0024 []byte
		zb0024, err = dc.ReadBytes((common.Address).Bytes(z.USDMAddress))
		if err != nil {
			err = msgp.WrapError(err, "USDMAddress")
			return
		}
		z.USDMAddress = common.BytesToAddress(zb0024)
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "USDM")
			return
		}
		z.USDM = nil
	} else {
...
func (z *Vault) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.WriteMapHeader(uint32(len(z.USDMAmounts)))
	if err != nil {
		err = msgp.WrapError(err, "USDMAmounts")
		return
	}
	for za0012, za0013 := range z.USDMAmounts {
	...
	err = en.WriteMapHeader(uint32(len(z.MaxUSDMAmounts)))
	if err != nil {
		err = msgp.WrapError(err, "MaxUSDMAmounts")
		return
	}
	for za0014, za0015 := range z.MaxUSDMAmounts {
	...
	err = en.WriteBytes((common.Address).Bytes(z.USDMAddress))
	if err != nil {
		err = msgp.WrapError(err, "USDMAddress")
		return
	}
...
func (z *Vault) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendMapHeader(o, uint32(len(z.USDMAmounts)))
	for za0012, za0013 := range z.USDMAmounts {
	...
	o = msgp.AppendMapHeader(o, uint32(len(z.MaxUSDMAmounts)))
	for za0014, za0015 := range z.MaxUSDMAmounts {
	...
	o = msgp.AppendBytes(o, (common.Address).Bytes(z.USDMAddress))
	if z.USDM == nil {
		o = msgp.AppendNil(o)
	} else {
		o, err = z.USDM.MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "USDM")
			return
		}
...
func (z *Vault) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	{
		var zb0024 []byte
		zb0024, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.USDMAddress))
		if err != nil {
			err = msgp.WrapError(err, "USDMAddress")
			return
		}
	...
	if msgp.IsNil(bts) {
		...
		bts, err = z.USDM.UnmarshalMsg(bts)
		if err != nil {
			err = msgp.WrapError(err, "USDM")
			return
		}
...
func (z *Vault) Msgsize() (s int) {
	...
	s += msgp.BytesPrefixSize + len((common.Address).Bytes(z.USDMAddress))
	if z.USDM == nil {
		s += msgp.NilSize
	} else {
		s += z.USDM.Msgsize()

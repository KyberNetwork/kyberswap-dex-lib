...
func (z *USDM) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0001 uint32
...
func (z *USDM) EncodeMsg(en *msgp.Writer) (err error) {
	// array header, size 2
	err = en.Append(0x92)
	if err != nil {
		return
...
func (z *USDM) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *USDM) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0001 uint32

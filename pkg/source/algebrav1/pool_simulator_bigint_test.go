...
func TestPoolSimulatorBigInt_CalcAmountOut(t *testing.T) {
	...
	p, err := NewPoolSimulatorBigInt(entity.Pool{
		Exchange: "",
		Type:     "",
...
func TestPoolSimulatorBigInt_UpdateBalance(t *testing.T) {
...
func TestPoolSimulatorBigInt_CalcAmountOut_SPL(t *testing.T) {
	_ = logger.SetLogLevel("debug")
...
func TestPoolSimulatorBigInt_CalcAmountOut_CommFee(t *testing.T) {
...
func TestPoolSimulatorBigInt_CalcAmountOut_v1_9(t *testing.T) {
...
func TestPoolSimulatorBigInt_CalcAmountOut_DirFee(t *testing.T) {
...
func TestPoolSimulatorBigInt_UpdateBalance_DirFee(t *testing.T) {
	_ = logger.SetLogLevel("debug")
	// test data from https://arbiscan.io/address/0x2f0bcb4a8bd714953eefd5339326ee0ff62c5b62#readContract
	// different fee for 2 directions
	testcases := []struct {

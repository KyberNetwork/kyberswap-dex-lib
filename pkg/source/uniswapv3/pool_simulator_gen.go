...
import (
	"github.com/KyberNetwork/kyberswap-dex-lib/pkg/msgpencode/uniswapv3uint256mspg"
...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0002 []byte
			zb0002, err = dc.ReadBytes(uniswapv3uint256mspg.EncodePool(z.V3Pool))
			if err != nil {
				err = msgp.WrapError(err, "V3Pool")
				return
			}
			z.V3Pool = uniswapv3uint256mspg.DecodePool(zb0002)
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.V3Pool == nil {
		...
		err = en.WriteBytes(uniswapv3uint256mspg.EncodePool(z.V3Pool))
		if err != nil {
			err = msgp.WrapError(err, "V3Pool")
			return
		}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.V3Pool == nil {
		...
		o = msgp.AppendBytes(o, uniswapv3uint256mspg.EncodePool(z.V3Pool))
	}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0002 []byte
			zb0002, bts, err = msgp.ReadBytesBytes(bts, uniswapv3uint256mspg.EncodePool(z.V3Pool))
			if err != nil {
				err = msgp.WrapError(err, "V3Pool")
				return
			}
...
func (z *PoolSimulator) Msgsize() (s int) {
	...
	if z.V3Pool == nil {
		...
		s += msgp.BytesPrefixSize + len(uniswapv3uint256mspg.EncodePool(z.V3Pool))
	}

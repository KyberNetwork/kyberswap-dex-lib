...
func (z *VaultPriceFeed) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	{
		var zb0017 []byte
		zb0017, err = dc.ReadBytes(encodePriceFeed(z.SecondaryPriceFeed))
		if err != nil {
			err = msgp.WrapError(err, "SecondaryPriceFeed")
			return
		}
		z.SecondaryPriceFeed = decodePriceFeed(zb0017)
	}
...
func (z *VaultPriceFeed) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	{
		var zb0017 []byte
		zb0017, bts, err = msgp.ReadBytesBytes(bts, encodePriceFeed(z.SecondaryPriceFeed))
		if err != nil {
			err = msgp.WrapError(err, "SecondaryPriceFeed")
			return
		}

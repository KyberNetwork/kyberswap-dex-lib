...
func (z *VaultPriceFeed) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	{
		var zb0016 []byte
		zb0016, err = dc.ReadBytes((common.Address).Bytes(z.SecondaryPriceFeedAddress))
		if err != nil {
			err = msgp.WrapError(err, "SecondaryPriceFeedAddress")
			return
		}
		z.SecondaryPriceFeedAddress = common.BytesToAddress(zb0016)
	}
	...
	if z.PriceFeedsAddresses == nil {
		z.PriceFeedsAddresses = make(map[string]common.Address, zb0017)
	...
	for zb0017 > 0 {
		...
		{
			var zb0018 []byte
			zb0018, err = dc.ReadBytes((common.Address).Bytes(za0012))
			if err != nil {
				err = msgp.WrapError(err, "PriceFeedsAddresses", za0011)
				return
			}
			za0012 = common.BytesToAddress(zb0018)
		}
	...
	if z.PriceFeeds == nil {
		z.PriceFeeds = make(map[string]*PriceFeed, zb0019)
...
func (z *VaultPriceFeed) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	{
		var zb0016 []byte
		zb0016, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.SecondaryPriceFeedAddress))
		if err != nil {
			err = msgp.WrapError(err, "SecondaryPriceFeedAddress")
			return
		}
	...
	for zb0017 > 0 {
		...
		{
			var zb0018 []byte
			zb0018, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(za0012))
			if err != nil {
				err = msgp.WrapError(err, "PriceFeedsAddresses", za0011)
				return
			}

...
func (z *VaultPriceFeed) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if z.PriceDecimals == nil {
		z.PriceDecimals = make(map[string]*big.Int, zb0005)
	...
	for zb0005 > 0 {
		...
		if dc.IsNil() {
			...
			{
				var zb0006 []byte
				zb0006, err = dc.ReadBytes(msgpencode.EncodeInt(za0002))
				if err != nil {
					err = msgp.WrapError(err, "PriceDecimals", za0001)
					return
				}
				za0002 = msgpencode.DecodeInt(zb0006)
			}
		}
	...
	if z.SpreadBasisPoints == nil {
		z.SpreadBasisPoints = make(map[string]*big.Int, zb0007)
	...
	for zb0007 > 0 {
		...
		if dc.IsNil() {
			...
			{
				var zb0008 []byte
				zb0008, err = dc.ReadBytes(msgpencode.EncodeInt(za0004))
				if err != nil {
					err = msgp.WrapError(err, "SpreadBasisPoints", za0003)
					return
				}
				za0004 = msgpencode.DecodeInt(zb0008)
			}
		}
	...
	if z.AdjustmentBasisPoints == nil {
		z.AdjustmentBasisPoints = make(map[string]*big.Int, zb0009)
	...
	if z.StrictStableTokens == nil {
		z.StrictStableTokens = make(map[string]bool, zb0011)
	...
	if z.IsAdjustmentAdditive == nil {
		z.IsAdjustmentAdditive = make(map[string]bool, zb0012)
	...
	{
		var zb0013 []byte
		zb0013, err = dc.ReadBytes((common.Address).Bytes(z.BNBBUSDAddress))
		if err != nil {
			err = msgp.WrapError(err, "BNBBUSDAddress")
			return
		}
		z.BNBBUSDAddress = common.BytesToAddress(zb0013)
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
	...
	{
		var zb0014 []byte
		zb0014, err = dc.ReadBytes((common.Address).Bytes(z.BTCBNBAddress))
		if err != nil {
			err = msgp.WrapError(err, "BTCBNBAddress")
			return
		}
		z.BTCBNBAddress = common.BytesToAddress(zb0014)
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
	...
	{
		var zb0015 []byte
		zb0015, err = dc.ReadBytes((common.Address).Bytes(z.ETHBNBAddress))
		if err != nil {
			err = msgp.WrapError(err, "ETHBNBAddress")
			return
		}
		z.ETHBNBAddress = common.BytesToAddress(zb0015)
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
	...
	{
		var zb0016 []byte
		zb0016, err = dc.ReadBytes((common.Address).Bytes(z.ChainlinkFlagsAddress))
		if err != nil {
			err = msgp.WrapError(err, "ChainlinkFlagsAddress")
			return
		}
		z.ChainlinkFlagsAddress = common.BytesToAddress(zb0016)
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
	...
	{
		var zb0018 []byte
		zb0018, err = dc.ReadBytes(encodePriceFeed(z.SecondaryPriceFeed))
		if err != nil {
			err = msgp.WrapError(err, "SecondaryPriceFeed")
			return
		}
		z.SecondaryPriceFeed = decodePriceFeed(zb0018)
	}
	...
	if z.PriceFeedsAddresses == nil {
		z.PriceFeedsAddresses = make(map[string]common.Address, zb0019)
	...
	for zb0019 > 0 {
		...
		{
			var zb0020 []byte
			zb0020, err = dc.ReadBytes((common.Address).Bytes(za0012))
			if err != nil {
				err = msgp.WrapError(err, "PriceFeedsAddresses", za0011)
				return
			}
			za0012 = common.BytesToAddress(zb0020)
		}
	...
	if z.PriceFeeds == nil {
		z.PriceFeeds = make(map[string]*PriceFeed, zb0021)
...
func (z *VaultPriceFeed) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0005 > 0 {
		...
		if msgp.IsNil(bts) {
			...
			{
				var zb0006 []byte
				zb0006, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(za0002))
				if err != nil {
					err = msgp.WrapError(err, "PriceDecimals", za0001)
					return
				}
	...
	for zb0007 > 0 {
		...
		if msgp.IsNil(bts) {
			...
			{
				var zb0008 []byte
				zb0008, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(za0004))
				if err != nil {
					err = msgp.WrapError(err, "SpreadBasisPoints", za0003)
					return
				}
	...
	{
		var zb0013 []byte
		zb0013, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.BNBBUSDAddress))
		if err != nil {
			err = msgp.WrapError(err, "BNBBUSDAddress")
			return
		}
	...
	{
		var zb0014 []byte
		zb0014, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.BTCBNBAddress))
		if err != nil {
			err = msgp.WrapError(err, "BTCBNBAddress")
			return
		}
	...
	{
		var zb0015 []byte
		zb0015, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.ETHBNBAddress))
		if err != nil {
			err = msgp.WrapError(err, "ETHBNBAddress")
			return
		}
	...
	{
		var zb0016 []byte
		zb0016, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(z.ChainlinkFlagsAddress))
		if err != nil {
			err = msgp.WrapError(err, "ChainlinkFlagsAddress")
			return
		}
	...
	{
		var zb0018 []byte
		zb0018, bts, err = msgp.ReadBytesBytes(bts, encodePriceFeed(z.SecondaryPriceFeed))
		if err != nil {
			err = msgp.WrapError(err, "SecondaryPriceFeed")
			return
		}
	...
	for zb0019 > 0 {
		...
		{
			var zb0020 []byte
			zb0020, bts, err = msgp.ReadBytesBytes(bts, (common.Address).Bytes(za0012))
			if err != nil {
				err = msgp.WrapError(err, "PriceFeedsAddresses", za0011)
				return
			}
...
func (z *VaultPriceFeed) Msgsize() (s int) {
	s = 3 + msgp.StringPrefixSize + len(z.BNB) + msgp.StringPrefixSize + len(z.BTC) + msgp.StringPrefixSize + len(z.ETH) + msgp.BoolSize + msgp.BoolSize + msgp.BoolSize
	if z.MaxStrictPriceDeviation == nil {
		s += msgp.NilSize
	} else {
	...
	s += msgp.BytesPrefixSize + len((common.Address).Bytes(z.BNBBUSDAddress))
	if z.BNBBUSD == nil {
		s += msgp.NilSize
	} else {
		s += z.BNBBUSD.Msgsize()

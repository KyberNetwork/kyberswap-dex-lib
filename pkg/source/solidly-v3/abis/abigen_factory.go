...
var FactoryMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"uint24\",\"name\":\"fee\",\"type\":\"uint24\"},{\"indexed\":true,\"internalType\":\"int24\",\"name\":\"tickSpacing\",\"type\":\"int24\"}],\"name\":\"FeeAmountEnabled\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"oldFeeCollector\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newFeeCollector\",\"type\":\"address\"}],\"name\":\"FeeCollectorChanged\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"uint256\",\"name\":\"newStatus\",\"type\":\"uint256\"}],\"name\":\"FeeSetterStatusToggled\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"oldOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnerChanged\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"token0\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"token1\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint24\",\"name\":\"fee\",\"type\":\"uint24\"},{\"indexed\":true,\"internalType\":\"int24\",\"name\":\"tickSpacing\",\"type\":\"int24\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"pool\",\"type\":\"address\"}],\"name\":\"PoolCreated\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"tokenA\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"tokenB\",\"type\":\"address\"},{\"internalType\":\"uint24\",\"name\":\"fee\",\"type\":\"uint24\"}],\"name\":\"createPool\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"pool\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint24\",\"name\":\"fee\",\"type\":\"uint24\"},{\"internalType\":\"int24\",\"name\":\"tickSpacing\",\"type\":\"int24\"}],\"name\":\"enableFeeAmount\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint24\",\"name\":\"\",\"type\":\"uint24\"}],\"name\":\"feeAmountTickSpacing\",\"outputs\":[{\"internalType\":\"int24\",\"name\":\"\",\"type\":\"int24\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"feeCollector\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getFeeSetters\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"int24\",\"name\":\"\",\"type\":\"int24\"}],\"name\":\"getPool\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"isFeeSetter\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"parameters\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"factory\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"token0\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"token1\",\"type\":\"address\"},{\"internalType\":\"uint24\",\"name\":\"fee\",\"type\":\"uint24\"},{\"internalType\":\"int24\",\"name\":\"tickSpacing\",\"type\":\"int24\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_feeCollector\",\"type\":\"address\"}],\"name\":\"setFeeCollector\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_owner\",\"type\":\"address\"}],\"name\":\"setOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"toggleFeeSetterStatus\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
// GetFeeSetters is a free data retrieval call binding the contract method 0xab9fbb0a.
//
// Solidity: function getFeeSetters() view returns(address[])
func (_Factory *FactoryCaller) GetFeeSetters(opts *bind.CallOpts) ([]common.Address, error) {
	var out []any
	err := _Factory.contract.Call(opts, &out, "getFeeSetters")
...
//
// Solidity: function getFeeSetters() view returns(address[])
func (_Factory *FactorySession) GetFeeSetters() ([]common.Address, error) {
	return _Factory.Contract.GetFeeSetters(&_Factory.CallOpts)
}

// GetFeeSetters is a free data retrieval call binding the contract method 0xab9fbb0a.
//
// Solidity: function getFeeSetters() view returns(address[])
func (_Factory *FactoryCallerSession) GetFeeSetters() ([]common.Address, error) {
	return _Factory.Contract.GetFeeSetters(&_Factory.CallOpts)
}
...
// IsFeeSetter is a free data retrieval call binding the contract method 0xbc8520d3.
//
// Solidity: function isFeeSetter(address ) view returns(uint256)
func (_Factory *FactoryCaller) IsFeeSetter(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []any
	err := _Factory.contract.Call(opts, &out, "isFeeSetter", arg0)
...
//
// Solidity: function isFeeSetter(address ) view returns(uint256)
func (_Factory *FactorySession) IsFeeSetter(arg0 common.Address) (*big.Int, error) {
	return _Factory.Contract.IsFeeSetter(&_Factory.CallOpts, arg0)
}

// IsFeeSetter is a free data retrieval call binding the contract method 0xbc8520d3.
//
// Solidity: function isFeeSetter(address ) view returns(uint256)
func (_Factory *FactoryCallerSession) IsFeeSetter(arg0 common.Address) (*big.Int, error) {
	return _Factory.Contract.IsFeeSetter(&_Factory.CallOpts, arg0)
}
...
// ToggleFeeSetterStatus is a paid mutator transaction binding the contract method 0x8e6df8f5.
//
// Solidity: function toggleFeeSetterStatus(address addr) returns()
func (_Factory *FactoryTransactor) ToggleFeeSetterStatus(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "toggleFeeSetterStatus", addr)
}

// ToggleFeeSetterStatus is a paid mutator transaction binding the contract method 0x8e6df8f5.
//
// Solidity: function toggleFeeSetterStatus(address addr) returns()
func (_Factory *FactorySession) ToggleFeeSetterStatus(addr common.Address) (*types.Transaction, error) {
	return _Factory.Contract.ToggleFeeSetterStatus(&_Factory.TransactOpts, addr)
}

// ToggleFeeSetterStatus is a paid mutator transaction binding the contract method 0x8e6df8f5.
//
// Solidity: function toggleFeeSetterStatus(address addr) returns()
func (_Factory *FactoryTransactorSession) ToggleFeeSetterStatus(addr common.Address) (*types.Transaction, error) {
	return _Factory.Contract.ToggleFeeSetterStatus(&_Factory.TransactOpts, addr)
}
...
// FactoryFeeSetterStatusToggledIterator is returned from FilterFeeSetterStatusToggled and is used to iterate over the raw logs and unpacked data for FeeSetterStatusToggled events raised by the Factory contract.
type FactoryFeeSetterStatusToggledIterator struct {
	Event *FactoryFeeSetterStatusToggled // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *FactoryFeeSetterStatusToggledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(FactoryFeeSetterStatusToggled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *FactoryFeeSetterStatusToggledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *FactoryFeeSetterStatusToggledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// FactoryFeeSetterStatusToggled represents a FeeSetterStatusToggled event raised by the Factory contract.
type FactoryFeeSetterStatusToggled struct {
	Addr      common.Address
	NewStatus *big.Int
	Raw       types.Log // Blockchain specific contextual infos
}

// FilterFeeSetterStatusToggled is a free log retrieval operation binding the contract event 0x9ef6cce4f35c67bd1d3db5ed9e622515f11e817975d7cdf23f0f17e1f5eb6227.
//
// Solidity: event FeeSetterStatusToggled(address indexed addr, uint256 indexed newStatus)
func (_Factory *FactoryFilterer) FilterFeeSetterStatusToggled(opts *bind.FilterOpts, addr []common.Address, newStatus []*big.Int) (*FactoryFeeSetterStatusToggledIterator, error) {

	var addrRule []any
	for _, addrItem := range addr {
		addrRule = append(addrRule, addrItem)
	}
	var newStatusRule []any
	for _, newStatusItem := range newStatus {
		newStatusRule = append(newStatusRule, newStatusItem)
	}

	logs, sub, err := _Factory.contract.FilterLogs(opts, "FeeSetterStatusToggled", addrRule, newStatusRule)
	if err != nil {
		return nil, err
	}
	return &FactoryFeeSetterStatusToggledIterator{contract: _Factory.contract, event: "FeeSetterStatusToggled", logs: logs, sub: sub}, nil
}

// WatchFeeSetterStatusToggled is a free log subscription operation binding the contract event 0x9ef6cce4f35c67bd1d3db5ed9e622515f11e817975d7cdf23f0f17e1f5eb6227.
//
// Solidity: event FeeSetterStatusToggled(address indexed addr, uint256 indexed newStatus)
func (_Factory *FactoryFilterer) WatchFeeSetterStatusToggled(opts *bind.WatchOpts, sink chan<- *FactoryFeeSetterStatusToggled, addr []common.Address, newStatus []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Factory.contract.WatchLogs(opts, "FeeSetterStatusToggled", addrRule, newStatusRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(FactoryFeeSetterStatusToggled)
				if err := _Factory.contract.UnpackLog(event, "FeeSetterStatusToggled", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFeeSetterStatusToggled is a log parse operation binding the contract event 0x9ef6cce4f35c67bd1d3db5ed9e622515f11e817975d7cdf23f0f17e1f5eb6227.
//
// Solidity: event FeeSetterStatusToggled(address indexed addr, uint256 indexed newStatus)
func (_Factory *FactoryFilterer) ParseFeeSetterStatusToggled(log types.Log) (*FactoryFeeSetterStatusToggled, error) {
	event := new(FactoryFeeSetterStatusToggled)
	if err := _Factory.contract.UnpackLog(event, "FeeSetterStatusToggled", log); err != nil {
		return nil, err
	}
...
//
// Solidity: event PoolCreated(address indexed token0, address indexed token1, uint24 fee, int24 indexed tickSpacing, address pool)

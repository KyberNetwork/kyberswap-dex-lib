...
//
//	mockgen -destination ./mock_iface.go -package swapbasedperp -source=iface.go
//
...
// Read indicates an expected call of Read.
func (mr *MockIFastPriceFeedV2ReaderMockRecorder) Read(ctx, address, tokens any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Read indicates an expected call of Read.
func (mr *MockIUSDBReaderMockRecorder) Read(ctx, address any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIFastPriceFeedMockRecorder) GetPrice(token, refPrice, maximise any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

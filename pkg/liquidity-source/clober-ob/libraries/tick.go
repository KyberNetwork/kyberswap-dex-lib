...
var (
	...
	ErrTickOverflow = errors.New("tick overflow")

	MaxTick Tick = 1<<19 - 1
	MinTick Tick = -MaxTick

	minPrice = uint256.MustFromDecimal("1350587")
	maxPrice = uint256.MustFromDecimal("4647684107270898330752324302845848816923571339324334")
	...
	r19 = uint256.MustFromHex("0x149b34")
...
func ValidatePrice(price uint256.Int) error {
	if price.Gt(maxPrice) || price.Lt(minPrice) {

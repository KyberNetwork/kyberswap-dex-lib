...
//
// Solidity: function getHighest(uint192 id) view returns(int24)
func (_BookManager *BookManagerCaller) GetHighest(opts *bind.CallOpts, id *big.Int) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getHighest(uint192 id) view returns(int24)
func (_BookManager *BookManagerSession) GetHighest(id *big.Int) (*big.Int, error) {
...
//
// Solidity: function getHighest(uint192 id) view returns(int24)
func (_BookManager *BookManagerCallerSession) GetHighest(id *big.Int) (*big.Int, error) {
	return _BookManager.Contract.GetHighest(&_BookManager.CallOpts, id)
}
...
//
// Solidity: function settle(address currency) payable returns(uint256 paid)
func (_BookManager *BookManagerTransactor) Settle(opts *bind.TransactOpts, currency common.Address) (*types.Transaction, error) {
	return _BookManager.contract.Transact(opts, "settle", currency)
}

// Settle is a paid mutator transaction binding the contract method 0x6a256b29.
//
// Solidity: function settle(address currency) payable returns(uint256 paid)
func (_BookManager *BookManagerSession) Settle(currency common.Address) (*types.Transaction, error) {
	return _BookManager.Contract.Settle(&_BookManager.TransactOpts, currency)
}

// Settle is a paid mutator transaction binding the contract method 0x6a256b29.
//
// Solidity: function settle(address currency) payable returns(uint256 paid)
func (_BookManager *BookManagerTransactorSession) Settle(currency common.Address) (*types.Transaction, error) {
	return _BookManager.Contract.Settle(&_BookManager.TransactOpts, currency)
}
...
func (_BookManager *BookManagerTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _BookManager.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_BookManager *BookManagerSession) Receive() (*types.Transaction, error) {
	return _BookManager.Contract.Receive(&_BookManager.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_BookManager *BookManagerTransactorSession) Receive() (*types.Transaction, error) {
	return _BookManager.Contract.Receive(&_BookManager.TransactOpts)
}

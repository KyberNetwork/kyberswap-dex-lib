...
func TestPoolTracker_GetNewPoolState(t *testing.T) {
	...
	pt := &PoolTracker{
		config:        &Config{DexID: DexType, CLPoolManager: "0x7fFE42C4a5DEeA5b0feC41C94C136Cf115597227"},
...
func TestPoolTracker_GetTickFromStateView(t *testing.T) {
	...
	pt := &PoolTracker{
		config: &Config{
			DexID:            DexType,
			CLPoolManager:    "0x76fd297e2d437cd7f76d50f01afe6160f86e9990",
			FetchTickFromRPC: true,
		},

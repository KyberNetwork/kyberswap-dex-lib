...
var (
	...
	VAULT_SHARE_PRICES_SLOT = big.NewInt(11)
	CURATOR_FEES_SLOT       = big.NewInt(15)
	HOOK_FEE_SLOT           = big.NewInt(16)
	...
	ZoneAddress            = common.HexToAddress("0x00000000Ff3ba1257149f69CD0d22263DD0A14ea") // All chains
	QuoterAddress          = common.HexToAddress("0x00000000E15009D51C6d57f7164f4Ed4996ae55C") // All chains
	BunniTokenAddress      = common.HexToAddress("0x000000C396558ffbAB5Ea628f39658Bdf61345b3") // All chains
	MasterBunniAddress     = common.HexToAddress("0x0000009856ebF1B73B431Fb59F2a2F200E9e78B0") // All chains
	OptionsTokenAddress    = common.HexToAddress("0x000000Dc51B82DC9C14c2c034341c912907d0d59") // All chains
	BunniHookOracleAddress = common.HexToAddress("0x0000001cC485ca6D3C966fBcbA7dba6302c45BA9") // All chains
	BunniZapInAddress      = common.HexToAddress("0x0000000000dFE4c0014A4fB7Fc63BB174b8aDB93") // All chains
	...
	LDFAddresses = map[string]func(int) ldf.ILiquidityDensityFunction{
		// Ethereum, Base, Unichain, BSC (shared addresses)

...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "swETHToETHRate")
			return
		}
		z.swETHToETHRate = nil
	} else {
		{
			var zb0002 []byte
			zb0002, err = dc.ReadBytes(msgpencode.EncodeInt(z.swETHToETHRate))
			if err != nil {
				err = msgp.WrapError(err, "swETHToETHRate")
				return
			}
			z.swETHToETHRate = msgpencode.DecodeInt(zb0002)
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.swETHToETHRate == nil {
		err = en.WriteNil()
		if err != nil {
			return
		}
	} else {
		err = en.WriteBytes(msgpencode.EncodeInt(z.swETHToETHRate))
		if err != nil {
			err = msgp.WrapError(err, "swETHToETHRate")
			return
		}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.swETHToETHRate == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeInt(z.swETHToETHRate))
	}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0002 []byte
			zb0002, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeInt(z.swETHToETHRate))
			if err != nil {
				err = msgp.WrapError(err, "swETHToETHRate")
				return
			}
...
func (z *PoolSimulator) Msgsize() (s int) {
	...
	if z.swETHToETHRate == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeInt(z.swETHToETHRate))
	}
	s += z.gas.Msgsize()
	return
}

...
func (z *Gas) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	z.DepositAsset, err = dc.ReadInt64()
	if err != nil {
		err = msgp.WrapError(err, "DepositAsset")
		return
	}
	return
}
...
func (z Gas) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.WriteInt64(z.DepositAsset)
	if err != nil {
		err = msgp.WrapError(err, "DepositAsset")
		return
	}
...
func (z Gas) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// array header, size 1
	o = append(o, 0x91)
	o = msgp.AppendInt64(o, z.DepositAsset)
	return
}
...
func (z *Gas) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	z.DepositAsset, bts, err = msgp.ReadInt64Bytes(bts)
	if err != nil {
		err = msgp.WrapError(err, "DepositAsset")
		return
	}

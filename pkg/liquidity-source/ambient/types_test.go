...
func TestNTokenPool_CanSwapTo(t *testing.T) {
	...
	require.Equal(t, []string{wethAddr}, nPool.CanSwapTo("0x0f2d719407fdbeff09d87557abb7232601fd9f29"))
	require.Equal(t, []string{wethAddr}, nPool.CanSwapTo("0x4e3fbd56cd56c3e72c1403e103b45db9da5b9d2b"))
	require.Equal(t, []string{wethAddr}, nPool.CanSwapTo("0x6982508145454ce325ddbe47a25d4ec3d2311933"))
	require.Equal(t,
	...
	require.Equal(t, []string{wethAddr}, nPool.CanSwapTo("0xd533a949740bb3306d119cc777fa900ba034cd52"))
	require.Equal(t,
		[]string{wethAddr, "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"},
...
func TestNTokenPool_GetPair(t *testing.T) {
	...
	_, ok = nPool.GetPair(common.HexToAddress("0xdeadbeef"), common.HexToAddress("0xcafebabe"))
	require.False(t, ok)
}

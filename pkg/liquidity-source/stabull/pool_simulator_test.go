...
// TestCalcAmountOut removed - replaced by TestPoolSimulator_ValidateAgainstViewOriginSwap
// which validates against actual contract behavior with real pools using viewOriginSwap

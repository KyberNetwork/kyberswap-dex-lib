...
// first Elite line (static 1/3/5% tiers, no schedule).
...
var AddressByChain = map[valueobject.ChainID]common.Address{
	valueobject.ChainIDArbitrumOne: common.HexToAddress("0x18a6ba193352036ef8a7c22be2cb288bb26da8cc"),
}

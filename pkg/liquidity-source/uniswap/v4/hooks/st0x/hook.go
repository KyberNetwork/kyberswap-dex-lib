...
func (h *Hook) Track(ctx context.Context, param *uniswapv4.HookParam) (json.RawMessage, error) {
	...
	var (
		priceData    struct{ Price, UpdatedAt, SpreadBps *big.Int }
	...
	req.AddCall(&ethrpc.Call{
		...
		Method: "getPrice",
		Params: []any{poolId},
	}, []any{&priceData}).AddCall(&ethrpc.Call{
		ABI:    propAMMHookABI,
		Target: hookAddr.Hex(),
		Method: "maxStaleness",
	...
	h.Price = priceData.Price.Uint64()
	h.UpdatedAt = priceData.UpdatedAt.Uint64()
	h.SpreadBps = priceData.SpreadBps.Uint64()

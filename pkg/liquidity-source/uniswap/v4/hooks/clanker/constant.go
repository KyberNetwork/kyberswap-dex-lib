...
var (
	...
	DynamicFeeHookAddresses = []common.Address{
		common.HexToAddress("0x34a45c6B61876d739400Bd71228CbcbD4F53E8cC"), // base v4.0.0
		common.HexToAddress("0x9A82BfCf5fd939CB7256f2d41479Bc0DC67968cC"), // base v2 v4.1.0
	...
	StaticFeeHookAddresses = []common.Address{
		common.HexToAddress("0xDd5EeaFf7BD481AD55Db083062b13a3cdf0A68CC"), // base v4.0.0
		common.HexToAddress("0xBF5ACAB339D2970938Ff4A2753d6cbbb8AaaE8cC"), // base v2 v4.1.0
		common.HexToAddress("0xb429d62f8f3bFFb98CdB9569533eA23bF0Ba28CC"), // base v2 v4.1.0 permission-ed
		common.HexToAddress("0xBc6e5aBDa425309c2534Bc2bC92562F5419ce8Cc"), // unichain v4.0.0
		common.HexToAddress("0xf7aC669593d2D9D01026Fa5B756DD5B4f7aAa8Cc"), // arbitrum v4.0.0

...
func Test_Pool_ETH_weETH(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "932286573969", got.TokenAmountOut.Amount.String())
}
...
func Test_Pool_ETH_USDC(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "4488997193", got.TokenAmountOut.Amount.String())
}
...
func Test_Pool_USDC_USDT(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "999093286", got.TokenAmountOut.Amount.String())
	...
	assert.NoError(t, err)
	assert.Equal(t, "1000895523", got.TokenAmountOut.Amount.String())
}
...
func Test_Quoter(t *testing.T) {
	...
	_, err := rpcClient.R().SetBlockNumber(big.NewInt(24663505)).AddCall(&ethrpc.Call{
		ABI:    bunniQuoterABI,

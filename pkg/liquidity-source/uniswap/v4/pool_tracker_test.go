...
func TestPoolTracker_GetNewPoolState(t *testing.T) {
	...
	pt := &PoolTracker{
		...
		ethrpcClient:  ethrpc.New("https://eth.drpc.org").SetMulticallContract(common.HexToAddress("0xcA11bde05977b3631167028862bE2a173976CA11")),
...
func TestPoolTracker_GetTickFromStateView(t *testing.T) {
	...
	pt := &PoolTracker{
		...
		ethrpcClient: ethrpc.New("https://arbitrum.drpc.org").

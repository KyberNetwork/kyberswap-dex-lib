...
var SignedSafeMath *signedSafeMath
...
// sqrt
// https://github.com/wombat-exchange/v1-core/blob/d9bb07de2272e0d9cb4c640671a925896b64fc14/contracts/wombat-core/libraries/SignedSafeMath.sol#L40
func (l *signedSafeMath) sqrt(y *big.Int, guess *big.Int) *big.Int {
	var z *big.Int

...
func (_Pool *PoolCaller) Swapper(opts *bind.CallOpts) (common.Address, error) {
	var out []any
	err := _Pool.contract.Call(opts, &out, "swapper")
...
//
// Solidity: function swapper() view returns(address)
func (_Pool *PoolSession) Swapper() (common.Address, error) {
	return _Pool.Contract.Swapper(&_Pool.CallOpts)
}

// Swapper is a free data retrieval call binding the contract method 0x2b3297f9.
//
// Solidity: function swapper() view returns(address)
func (_Pool *PoolCallerSession) Swapper() (common.Address, error) {
	return _Pool.Contract.Swapper(&_Pool.CallOpts)
}
...
// SetSwapper is a paid mutator transaction binding the contract method 0x9c82f2a4.
//
// Solidity: function setSwapper(address _swapper) returns()
func (_Pool *PoolTransactor) SetSwapper(opts *bind.TransactOpts, _swapper common.Address) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "setSwapper", _swapper)
}

// SetSwapper is a paid mutator transaction binding the contract method 0x9c82f2a4.
//
// Solidity: function setSwapper(address _swapper) returns()
func (_Pool *PoolSession) SetSwapper(_swapper common.Address) (*types.Transaction, error) {
	return _Pool.Contract.SetSwapper(&_Pool.TransactOpts, _swapper)
}

// SetSwapper is a paid mutator transaction binding the contract method 0x9c82f2a4.
//
// Solidity: function setSwapper(address _swapper) returns()
func (_Pool *PoolTransactorSession) SetSwapper(_swapper common.Address) (*types.Transaction, error) {
	return _Pool.Contract.SetSwapper(&_Pool.TransactOpts, _swapper)
}
...
// PoolSwapperSetIterator is returned from FilterSwapperSet and is used to iterate over the raw logs and unpacked data for SwapperSet events raised by the Pool contract.
type PoolSwapperSetIterator struct {
	Event *PoolSwapperSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PoolSwapperSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PoolSwapperSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PoolSwapperSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PoolSwapperSet represents a SwapperSet event raised by the Pool contract.
type PoolSwapperSet struct {
	Swapper common.Address
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterSwapperSet is a free log retrieval operation binding the contract event 0x673779832598d6a388768ee342f8de96fdd5c39a468a6955377cf1405b9652b9.
//
// Solidity: event SwapperSet(address indexed swapper)
func (_Pool *PoolFilterer) FilterSwapperSet(opts *bind.FilterOpts, swapper []common.Address) (*PoolSwapperSetIterator, error) {
	...
	logs, sub, err := _Pool.contract.FilterLogs(opts, "SwapperSet", swapperRule)
	if err != nil {
		return nil, err
	}
	return &PoolSwapperSetIterator{contract: _Pool.contract, event: "SwapperSet", logs: logs, sub: sub}, nil
}

// WatchSwapperSet is a free log subscription operation binding the contract event 0x673779832598d6a388768ee342f8de96fdd5c39a468a6955377cf1405b9652b9.
//
// Solidity: event SwapperSet(address indexed swapper)
func (_Pool *PoolFilterer) WatchSwapperSet(opts *bind.WatchOpts, sink chan<- *PoolSwapperSet, swapper []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Pool.contract.WatchLogs(opts, "SwapperSet", swapperRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PoolSwapperSet)
				if err := _Pool.contract.UnpackLog(event, "SwapperSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseSwapperSet is a log parse operation binding the contract event 0x673779832598d6a388768ee342f8de96fdd5c39a468a6955377cf1405b9652b9.
//
// Solidity: event SwapperSet(address indexed swapper)
func (_Pool *PoolFilterer) ParseSwapperSet(log types.Log) (*PoolSwapperSet, error) {
	event := new(PoolSwapperSet)
	if err := _Pool.contract.UnpackLog(event, "SwapperSet", log); err != nil {
		return nil, err
	}

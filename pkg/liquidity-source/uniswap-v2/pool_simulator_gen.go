...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0002 []byte
			zb0002, err = dc.ReadBytes(msgpencode.EncodeUint256(z.fee))
			if err != nil {
				err = msgp.WrapError(err, "fee")
				return
			}
			z.fee = msgpencode.DecodeUint256(zb0002)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		...
		{
			var zb0003 []byte
			zb0003, err = dc.ReadBytes(msgpencode.EncodeUint256(z.feePrecision))
			if err != nil {
				err = msgp.WrapError(err, "feePrecision")
				return
			}
			z.feePrecision = msgpencode.DecodeUint256(zb0003)
		}
	}
	var zb0004 uint32
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0002 []byte
			zb0002, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.fee))
			if err != nil {
				err = msgp.WrapError(err, "fee")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0003 []byte
			zb0003, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.feePrecision))
			if err != nil {
				err = msgp.WrapError(err, "feePrecision")
				return
			}

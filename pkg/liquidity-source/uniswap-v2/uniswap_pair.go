...
//
// Solidity: function nonces(address ) view returns(uint256)
func (_Uniswap *UniswapSession) Nonces(arg0 common.Address) (*big.Int, error) {
	return _Uniswap.Contract.Nonces(&_Uniswap.CallOpts, arg0)
}

// Nonces is a free data retrieval call binding the contract method 0x7ecebe00.
//
// Solidity: function nonces(address ) view returns(uint256)
func (_Uniswap *UniswapCallerSession) Nonces(arg0 common.Address) (*big.Int, error) {
	return _Uniswap.Contract.Nonces(&_Uniswap.CallOpts, arg0)
}
...
func (_Uniswap *UniswapTransactor) Initialize(opts *bind.TransactOpts, _token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _Uniswap.contract.Transact(opts, "initialize", _token0, _token1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _token0, address _token1) returns()
func (_Uniswap *UniswapSession) Initialize(_token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _Uniswap.Contract.Initialize(&_Uniswap.TransactOpts, _token0, _token1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _token0, address _token1) returns()
func (_Uniswap *UniswapTransactorSession) Initialize(_token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _Uniswap.Contract.Initialize(&_Uniswap.TransactOpts, _token0, _token1)
}

...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		{
			var zb0004 []byte
			zb0004, err = dc.ReadBytes(msgpencode.EncodeUint256(z.swapFeePercentage))
			if err != nil {
				err = msgp.WrapError(err, "swapFeePercentage")
				return
			}
			z.swapFeePercentage = msgpencode.DecodeUint256(zb0004)
		}
	}
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "root3Alpha")
			return
		}
		z.root3Alpha = nil
	} else {
		{
			var zb0005 []byte
			zb0005, err = dc.ReadBytes(msgpencode.EncodeUint256(z.root3Alpha))
			if err != nil {
				err = msgp.WrapError(err, "root3Alpha")
				return
			}
			z.root3Alpha = msgpencode.DecodeUint256(zb0005)
		}
	}
	var zb0006 uint32
	zb0006, err = dc.ReadArrayHeader()
	if err != nil {
		err = msgp.WrapError(err, "poolTokenInfos")
		return
	}
	if cap(z.poolTokenInfos) >= int(zb0006) {
		z.poolTokenInfos = (z.poolTokenInfos)[:zb0006]
	} else {
		z.poolTokenInfos = make([]PoolTokenInfo, zb0006)
	}
	for za0002 := range z.poolTokenInfos {
		err = z.poolTokenInfos[za0002].DecodeMsg(dc)
		if err != nil {
			err = msgp.WrapError(err, "poolTokenInfos", za0002)
			return
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.root3Alpha == nil {
		...
		err = en.WriteBytes(msgpencode.EncodeUint256(z.root3Alpha))
		if err != nil {
			err = msgp.WrapError(err, "root3Alpha")
			return
		}
	}
	err = en.WriteArrayHeader(uint32(len(z.poolTokenInfos)))
	if err != nil {
		err = msgp.WrapError(err, "poolTokenInfos")
		return
	}
	for za0002 := range z.poolTokenInfos {
		err = z.poolTokenInfos[za0002].EncodeMsg(en)
		if err != nil {
			err = msgp.WrapError(err, "poolTokenInfos", za0002)
			return
		}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.root3Alpha == nil {
		...
		o = msgp.AppendBytes(o, msgpencode.EncodeUint256(z.root3Alpha))
	}
	o = msgp.AppendArrayHeader(o, uint32(len(z.poolTokenInfos)))
	for za0002 := range z.poolTokenInfos {
		o, err = z.poolTokenInfos[za0002].MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "poolTokenInfos", za0002)
			return
		}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0004 []byte
			zb0004, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.swapFeePercentage))
			if err != nil {
				err = msgp.WrapError(err, "swapFeePercentage")
				return
			}
	...
	if msgp.IsNil(bts) {
		...
		{
			var zb0005 []byte
			zb0005, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.root3Alpha))
			if err != nil {
				err = msgp.WrapError(err, "root3Alpha")
				return
			}
	...
	for za0002 := range z.poolTokenInfos {
		bts, err = z.poolTokenInfos[za0002].UnmarshalMsg(bts)
		if err != nil {
			err = msgp.WrapError(err, "poolTokenInfos", za0002)
			return
		}
...
func (z *PoolSimulator) Msgsize() (s int) {
	s = 1 + z.Pool.Msgsize() + msgp.BoolSize + msgp.ArrayHeaderSize
	for za0001 := range z.scalingFactors {
		if z.scalingFactors[za0001] == nil {
			s += msgp.NilSize
		} else {
	...
	if z.root3Alpha == nil {
		...
		s += msgp.BytesPrefixSize + len(msgpencode.EncodeUint256(z.root3Alpha))
	}
	s += msgp.ArrayHeaderSize
	for za0002 := range z.poolTokenInfos {
		s += z.poolTokenInfos[za0002].Msgsize()
	}
	s += msgp.StringPrefixSize + len(z.vault) + msgp.StringPrefixSize + len(z.poolID) + msgp.StringPrefixSize + len(z.poolType) + msgp.IntSize
	return
}

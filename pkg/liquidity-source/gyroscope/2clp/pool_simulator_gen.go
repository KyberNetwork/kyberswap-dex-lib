...
func (z *PoolSimulator) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if err != nil {
		err = msgp.WrapError(err, "sqrtParameters")
		return
	}
	if cap(z.sqrtParameters) >= int(zb0005) {
		z.sqrtParameters = (z.sqrtParameters)[:zb0005]
	} else {
		z.sqrtParameters = make([]*uint256.Int, zb0005)
	}
	for za0002 := range z.sqrtParameters {
		if dc.IsNil() {
			err = dc.ReadNil()
			if err != nil {
				err = msgp.WrapError(err, "sqrtParameters", za0002)
				return
			}
			z.sqrtParameters[za0002] = nil
		} else {
			{
				var zb0006 []byte
				zb0006, err = dc.ReadBytes(msgpencode.EncodeUint256(z.sqrtParameters[za0002]))
				if err != nil {
					err = msgp.WrapError(err, "sqrtParameters", za0002)
					return
				}
				z.sqrtParameters[za0002] = msgpencode.DecodeUint256(zb0006)
			}
		}
	}
...
func (z *PoolSimulator) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.WriteArrayHeader(uint32(len(z.sqrtParameters)))
	if err != nil {
		err = msgp.WrapError(err, "sqrtParameters")
		return
	}
	for za0002 := range z.sqrtParameters {
		if z.sqrtParameters[za0002] == nil {
			err = en.WriteNil()
			if err != nil {
				return
			}
		} else {
			err = en.WriteBytes(msgpencode.EncodeUint256(z.sqrtParameters[za0002]))
			if err != nil {
				err = msgp.WrapError(err, "sqrtParameters", za0002)
				return
			}
...
func (z *PoolSimulator) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendArrayHeader(o, uint32(len(z.sqrtParameters)))
	for za0002 := range z.sqrtParameters {
		if z.sqrtParameters[za0002] == nil {
			o = msgp.AppendNil(o)
		} else {
			o = msgp.AppendBytes(o, msgpencode.EncodeUint256(z.sqrtParameters[za0002]))
		}
	}
...
func (z *PoolSimulator) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for za0002 := range z.sqrtParameters {
		if msgp.IsNil(bts) {
			...
			{
				var zb0006 []byte
				zb0006, bts, err = msgp.ReadBytesBytes(bts, msgpencode.EncodeUint256(z.sqrtParameters[za0002]))
				if err != nil {
					err = msgp.WrapError(err, "sqrtParameters", za0002)
					return
				}
...
func (z *PoolSimulator) Msgsize() (s int) {
	...
	for za0002 := range z.sqrtParameters {
		if z.sqrtParameters[za0002] == nil {
			...
			s += msgp.BytesPrefixSize + len(msgpencode.EncodeUint256(z.sqrtParameters[za0002]))
		}
	}

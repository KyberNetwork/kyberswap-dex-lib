...
func (d *PoolTracker) getNewPoolState(
	...
	reserves, pairReserves, gradThreshold, tokenInfo, blockNumber, err := d.getBondingData(
...
func (d *PoolTracker) getBondingData(
...
) ([]*big.Int, [2]*big.Int, *big.Int, *BondingTokenInfo, *big.Int, error) {
	...
	if err != nil {
		return nil, [2]*big.Int{}, nil, nil, nil, err
	}

	return tokenBalances, reserves, gradThreshold, &tokenInfo, resp.BlockNumber, nil
}

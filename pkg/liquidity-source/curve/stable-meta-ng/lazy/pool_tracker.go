...
var _ = pooltrack.RegisterFactoryCE(stablemetang.DexType, NewPoolTracker)
...
func updateRateMultipliers(lg logger.Logger, extra *stablemetang.Extra, numTokens int, customRates []*big.Int) error {

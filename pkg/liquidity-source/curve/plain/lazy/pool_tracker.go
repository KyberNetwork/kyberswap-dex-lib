...
var _ = pooltrack.RegisterFactoryCE(plain.DexType, NewPoolTracker)
...
func addRPCCalls(addFn func(*ethrpc.Call, []any), poolAddress string, numTokens int,
	...
	if mainRegistryAddress != "" {
		addFn(&ethrpc.Call{
			...
			Method: plain.MainRegistryMethodGetRates,
...
func updateRateMultipliers(lg logger.Logger, extra *plain.Extra, numTokens int,

...
func TestConcentrationQ48_ZeroAmount(t *testing.T) {
	var c uint256.Int
	concentrationQ48(&c, new(uint256.Int).Lsh(uint256.NewInt(1), 96), new(uint256.Int),
...
func TestConcentrationQ48_ZeroK(t *testing.T) {
	var c uint256.Int
	concentrationQ48(&c, new(uint256.Int).Lsh(uint256.NewInt(1), 96), uint256.NewInt(1000),
...
func TestConcentrationQ48_SaturatesAtQ48(t *testing.T) {
	...
	var c uint256.Int
	concentrationQ48(&c, new(uint256.Int).Lsh(uint256.NewInt(1), 96), uint256.NewInt(1_000_000_000_000),

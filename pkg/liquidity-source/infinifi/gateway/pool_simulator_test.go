...
func TestPoolSimulator_CalcAmountOut(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "iUSD -> liUSD-1w (lock) - 1 iUSD to 1 liUSD",
			indexIn: 1, indexOut: 3, amountIn: "1000000000000000000", amountOut: "1000000000000000000"},
		{name: "iUSD -> liUSD-2w (lock) - 1 iUSD to 0.8 liUSD (0.8:1 rate)",
		...
		{name: "USDC -> liUSD-1w (mintAndLock) - 1 USDC to 1 liUSD",
			indexIn: 0, indexOut: 3, amountIn: "1000000", amountOut: "1000000000000000000"},
		{name: "USDC -> liUSD-2w (mintAndLock) - 1 USDC to 0.8 liUSD",
